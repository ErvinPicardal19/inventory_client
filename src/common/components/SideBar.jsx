          ...
          <>
            <div className='flex justify-between items-center'>
              <Link 
                ...
                gap-3 ml-3 mt-4 flex text-lg font-extrabold tracking-tight dark:text-white text-slate-900"
              >

                <img
                  src={currentMode === "Dark" ? require('../../data/LOGO_DARK.png') : require('../../data/LOGO.png')}
                  alt='logo'
                  className='w-16 h-16'
              ...
              >
                ...
                <button 
                  type='button' 
                  onClick={() => {setActiveMenu(false)}} className="text-xl rounded-full p-3 hover:bg-light-gray mt-4 block md:hidden"
                >
                  <MdOutlineCancel/>
                </button>
